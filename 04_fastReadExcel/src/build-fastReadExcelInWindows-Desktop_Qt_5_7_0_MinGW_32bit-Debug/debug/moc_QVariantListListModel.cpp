...
struct qt_meta_stringdata_QVariantListListModel_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QVariantListListModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QVariantListListModel_t qt_meta_stringdata_QVariantListListModel = {
    {
QT_MOC_LITERAL(0, 0, 21) // "QVariantListListModel"
...
const QMetaObject QVariantListListModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_QVariantListListModel.data,
      qt_meta_data_QVariantListListModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QVariantListListModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QVariantListListModel.stringdata0))
